...
const createScreenshot = createAsyncThunk('camera/createScreenshot', async ({ cameraId, parentId }) => {
  try {
    console.log('camera/createScreenshot cameraId, parentId -', cameraId, parentId);
